package com.tens.mahjongessential.ui.calculation;
...
public class calculationFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        getView().findViewById(R.id.calculation_button1).
                setOnClickListener(Navigation.createNavigateOnClickListener(R.id.action_calculationFragment_to_navigation_home));
    }
}